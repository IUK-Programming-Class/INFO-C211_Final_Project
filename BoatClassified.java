...
public class BoatClassified extends Classified {

	private int horsepower;
	private int hours;

	public BoatClassified(int adNumber, String make, String model, int year, String contactName, String contactNumber,
